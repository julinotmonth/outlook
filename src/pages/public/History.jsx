  ...
  const filteredBookings = useMemo(() => {
    return bookings.filter((booking) => {
      ...
      const matchesSearch = 
        ...
        booking.services.some(s => s.name.toLowerCase().includes(searchQuery.toLowerCase()))
          ...
          {bookingToCancel && (
            <div className="p-4 bg-charcoal-dark rounded-lg">
              ...
              <p className="text-cream/60 text-sm">
                {format(new Date(bookingToCancel.date), 'EEEE, dd MMMM yyyy', { locale: id })}
              </p>
            </div>
          )}
        </div>
            ...
            <div className="flex-1 p-6">
              ...
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="text-cream text-sm font-medium">{booking.barber.name}</p>
                ...
                {booking.paymentMethod && (
                  <div className="flex items-center gap-2 text-cream/70">
                    ...
                    <span className="text-sm">{booking.paymentMethod.name}</span>
                  </div>
                )}
              </div>
            </div>
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-cream/60">Pukul {booking.time}</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <p className="text-cream font-medium">{booking.barber.name}</p>
            </div>
          </div>
          ...
          {booking.paymentMethod && (
            <div>
              ...
              <p className="text-cream">{booking.paymentMethod.name}</p>
            </div>
          )}
          ...
          {booking.customer && (
            <div>
              ...
              <div className="space-y-1 text-sm">
                <p className="text-cream"><span className="text-cream/60">Nama:</span> {booking.customer.name}</p>
                <p className="text-cream"><span className="text-cream/60">Email:</span> {booking.customer.email}</p>
                <p className="text-cream"><span className="text-cream/60">Telepon:</span> {booking.customer.phone}</p>
                {booking.customer.notes && (
                  <p className="text-cream"><span className="text-cream/60">Catatan:</span> {booking.customer.notes}</p>
                )}
              </div>
            </div>
          )}
          ...
          <div className="pt-4 border-t border-gold/20">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <p className="text-cream">{formatDuration(booking.totalDuration)}</p>
              </div>
            </div>
          </div>
        </div>
