    ...
    <div className="space-y-4 sm:space-y-6">
            ...
            >
              <Card className={cn(
                ...
                <div className="aspect-square relative">
                  ...
                  >
                    {item.isActive ? (
                      <ToggleRight className="w-5 h-5 text-green-500 drop-shadow-lg" />
                    ) : (
                      <ToggleLeft className="w-5 h-5 text-cream/50 drop-shadow-lg" />
                    )}
                  </button>
                </div>
      ...
      >
        <form onSubmit={handleSubmit} className="py-4 space-y-4">
          ...
          <div>
            <label className="block text-cream text-sm font-medium mb-1.5">URL Gambar (opsional)</label>
            <Input
              name="image"
