                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm mb-3">
                      ...
                      <div className="flex items-center gap-2 text-cream/60">
                        ...
                        <span>{format(new Date(booking.date), 'dd MMM yyyy', { locale: id })}</span>
                      </div>
                      <div className="flex items-center gap-2 text-cream/60">
                  ...
                  <tbody>
                    {paginatedBookings.map((booking, index) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div>
                            <p className="text-cream font-medium text-sm">{booking.customer?.name || '-'}</p>
                            <p className="text-cream/50 text-xs">{booking.customer?.phone || '-'}</p>
                          </div>
                        </td>
                        <td className="py-4 px-4">
                        ...
                        <td className="py-4 px-4">
                          <div className="text-sm">
                            <p className="text-cream">{format(new Date(booking.date), 'dd MMM yyyy', { locale: id })}</p>
                            <p className="text-cream/50 text-xs">{booking.time}</p>
                          </div>
                        </td>
                        <td className="py-4 px-4">
                          <span className="text-gold font-display">{formatCurrency(booking.totalPrice)}</span>
                        </td>
                        <td className="py-4 px-4">
                          <StatusBadge status={booking.status} />
                        </td>
          ...
          <div className="py-2 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between p-3 bg-charcoal-dark rounded-lg">
              <div>
                ...
                <p className="text-cream/50 text-xs mt-0.5">
                  {format(new Date(selectedBooking.createdAt), 'dd MMM yyyy, HH:mm', { locale: id })}
                </p>
              </div>
            ...
            <div>
              ...
              <div className="bg-charcoal-dark rounded-lg p-3 space-y-2">
                <p className="text-cream font-medium">{selectedBooking.customer?.name || '-'}</p>
            ...
            {selectedBooking.paymentMethod && (
              <div>
                ...
                <div className="bg-charcoal-dark rounded-lg p-3">
                  <p className="text-cream text-sm">{selectedBooking.paymentMethod.name}</p>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="bg-charcoal-dark rounded-lg p-3">
                  <p className="text-cream text-sm">
                    {format(new Date(selectedBooking.date), 'dd MMM yyyy', { locale: id })}
                  </p>
                  <p className="text-cream/60 text-xs">{selectedBooking.time}</p>
                </div>
              </div>
            </div>
        ...
        <div className="py-4">
          ...
          {actionModal.booking && (
            <div className="mt-4 p-3 bg-charcoal-dark rounded-lg">
              ...
              <p className="text-cream font-medium">{actionModal.booking.customer?.name || '-'}</p>
              <p className="text-cream/60 text-sm">
                {format(new Date(actionModal.booking.date), 'dd MMM yyyy', { locale: id })} • {actionModal.booking.time}
              </p>
              <p className="text-gold font-display mt-2">{formatCurrency(actionModal.booking.totalPrice)}</p>
            </div>
          )}
        </div>
